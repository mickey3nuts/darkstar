...
-- DYNAMIS SETTINGS
    ...
    TIMELESS_HOURGLASS_COST = 1;   -- cost of the timeless hourglass for Dynamis.
...
RELIC_2ND_UPGRADE_WAIT_TIME = 1;      -- wait time for 2nd relic upgrade (stage 2 -> stage 3) in seconds. 604800s = 1 RL week.
RELIC_3RD_UPGRADE_WAIT_TIME = 1;      -- wait time for 3rd relic upgrade (stage 3 -> stage 4) in seconds. 295200s = 82 hours.
...
BARD_INSTRUMENT_LIMIT = 3; --Maximum amount of songs from a single Bard with an instrument that can be granted to a single target at once.  Set between 2 and 32.
...
KLIMAFORM_MACC = 50;  -- magic accuracy added by Klimaform. 30 is just a guess.
...
SNEAK_INVIS_DURATION_MULTIPLIER = 1.5; -- multiplies duration of sneak,invis,deodorize to reduce player torture. 1 = retail behavior. MUST BE INTEGER.
